...
public class Product implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = -3337694065280406893L;
     ...
     * @param updatedAt
     */
    public Product(Integer id, String name, String alamat, String noPlat, Integer informasiId, String jenisKendaraan, String status, String penunggakan, String lamaCicilan, String warna, String typeKendaraan, String merk, String imagePlat, String lat, String lon, String createdAt, String updatedAt) {
        super();
        this.id = id;
        this.name = name;
        this.alamat = alamat;
